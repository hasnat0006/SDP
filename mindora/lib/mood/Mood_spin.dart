...
class _MoodPageState extends State<MoodPage> {
  final List<Map<String, dynamic>> moods = [
    {
      "label": "Angry",
      "emoji": "😠",
      "color": const Color.fromARGB(255, 221, 87, 82),
    },
    {
      "label": "Sad",
      "emoji": "🙁",
      "color": const Color.fromARGB(255, 238, 145, 64),
    },
    {"label": "Stressed", "emoji": "😣", "color": const Color(0xFFF6D55C)},
    {
      "label": "Happy",
      "emoji": "😊",
      "color": const Color.fromARGB(255, 168, 197, 168),
    },
    {
      "label": "Excited",
      "emoji": "🥳",
  ...
  void _snapToClosestMood() {
    ...
    int index =
        ((diff + segmentAngle / 2) / segmentAngle).floor() % moods.length;
                  ...
                  child: ClipRect(
                    child: Align(
                      ...
                      child: CustomPaint(
                        ...
                        painter: LabeledArcPainter(moods: moods, angle: angle),
                      ),
                    ),
                  ),
                ),
    ...
    final hoverGlow = Paint()
      ..shader =
          RadialGradient(
            ...
            Rect.fromCircle(
              center: center,
              radius: radius + arcThickness * 0.8,
            ),
          );
